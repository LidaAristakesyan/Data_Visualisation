...
app.layout = html.Div([
        dcc.Tabs(id='tabs-example', value='tab-1', children=[
            dcc.Tab(label='Spotify Tracks.Overview', value='tab-1'),
    ...
    if tab == 'tab-1':
        return html.Div([
            dbc.Container([
                html.Br(),
                dbc.Row([
                    dbc.Col(html.H1(children='Spotify Tracks.Overview', className="text-center"), className="mb-2")
                ]),
                dbc.Row([
                    dbc.Col(html.H6(children='Music trends from 1995 - 2020', className="text-center"), className="mb-4")
                ]),
                html.Br(),
                dbc.Row([
                    dbc.Col(dbc.Card(html.H3(children='Top Tracks 1995 - 2020',
                ...
                dash_table.DataTable(
                    ...
                    style_table={'overflowX': 'scroll',
                                    'padding': '10px'},
                    style_header={'backgroundColor': '#22747a', 'color': 'white'},
                    style_cell={
        ...
        return html.Div([
            dbc.Container([
                html.Br(),
                dbc.Row([
                    dbc.Col(html.H1(children='Audio Features of Hit songs', className="text-center"), className="mb-3")
                ]),
                dbc.Row([
                    dbc.Col(html.H6(children='Analyzing audio features over the years', className="text-center"), className="mb-3")
                ]),
                html.Br(),
                dbc.Row([
                    dbc.Col(dbc.Card(html.H3(children='Audio Features of Songs',
                                             className="text-center text-light bg-dark"), body=True, color="dark"), className="mb-3")
                ]),
                dbc.Row([
...
def update_features_chart(year, show_artist, artist, feature):
    ...
    fig.update_layout(title_text='How has audio features changed over the years', title_x=0.5,
